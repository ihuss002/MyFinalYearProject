  ...
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        ...
        <p class="lead text-muted mb-0">We as a comapany are striving to create ease and simplicity for the car owners community. We are here to provide an effortless experience for buyers and sellers of all car parts. We have a passion for cars and know how difficult it can be to find specific and old parts. With our platform you will be able to find the parts you need.</p>
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">Simplicity is key on this platform. Register an account and effortlessly add items to your selling lists. Communicate with buyers with ease.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
  ...
  <div class="container py-5">
    <div class="row mb-4">
      <div class="col-lg-5">
        ...
        <p class="font-italic text-muted">We are here to support your every needs. </p>
      </div>
    </div>
