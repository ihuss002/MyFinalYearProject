                        ...
                        <div id="hero" class="homepage-slider3">
                            <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                                <div class="full-width-slider">
                                    <div class="item" style="background-image: url(assets/images/sliders/6.jpg);">
                                    </div>
                                </div>
                                <div class="full-width-slider">
                ...
                <div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
                    <div class="more-info-tab clearfix">
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            <li><a href="#mid" data-toggle="tab">Mid Size</a></li>
                            <li><a href="#compact" data-toggle="tab">Compact</a></li>
                        </ul><!-- /.nav-tabs -->
                    </div>
...
<div class="tab-pane" id="mid">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    <?php
$ret=mysqli_query($con,"select * from products where category=3 and status='active'");
while ($row=mysqli_fetch_array($ret)) 
{
...
?>
                        ...
                        <div class="tab-pane" id="compact">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    <?php
$ret=mysqli_query($con,"select * from products where category=2 and status='active'");
while ($row=mysqli_fetch_array($ret)) 
{
?>
                                    <div class="item item-carousel">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <section class="section">
                                <h3 class="section-title">Micro Cars</h3>
                                <div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme"
                                    data-item="2">

                                    <?php
$ret=mysqli_query($con,"select * from products where category=3 and subCategory=3 and status='active'");
while ($row=mysqli_fetch_array($ret)) 
{
?>
                                    <div class="item item-carousel">
                        ...
                        <div class="col-md-6">
                            <section class="section">
                                <h3 class="section-title">Compact</h3>
                                <div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme"
                                    data-item="2">
                                    <?php
$ret=mysqli_query($con,"select * from products where category=2 and subCategory=13 and status='active'");
while ($row=mysqli_fetch_array($ret)) 
{
?>
