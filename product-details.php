                ...
                <div class='col-md-3 sidebar'>
                    ...
                    <div class="sidebar-module-container">
                        <div class="sidebar-widget outer-bottom-xs wow fadeInUp">
                            <h3 class="section-title">Seller Info</h3>
                            <div class="sidebar-widget-body m-t-10">
                                <div>
                                    <?php $sql = mysqli_query($con, "SELECT users.Id, users.user_name, user_email, users.user_phone from users inner join products on products.userId=users.Id WHERE products.id='$pid'");
                                    while ($row = mysqli_fetch_array($sql)) { ?>
                                    <div>
                                        <div>
                                            <h3>
                                                <a href="user-products.php?uid=<?php
                                            $userID=$row['Id'];
                                            echo $row['Id']; ?>">
                                ...
                                <div class="quantity-container info-container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <a href="send-msg.php?puserid=<?php echo $userID; ?>"
                                                class="btn btn-primary"><i class="inner-right-vs"></i> MESSAGE TO
                                                OWNER</a>
                                            <?php } else {?>
