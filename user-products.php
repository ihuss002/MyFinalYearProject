...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"update products set status='inactive' where id = '".$_GET['did']."'");
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane active " id="grid-container">
                                <div class="category-product  inner-top-vs">
                                    <div class="row">
                                        <?php
$ret = mysqli_query($con, "select * from products where userId='$uid' and status='active'");
                                                    ...
                                                    <div class="cart clearfix animate-effect">
                                                        <div class="action">
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li>
                                                                <?php if ($userloginid == $uid) {?>
                                                                    <a
                                                                        href="edit-product.php?pid=<?php echo htmlentities($row['id']); ?>">
                                                                        <button class="btn btn-primary"
                                                                            type="button">Edit</button></a>
                                                                            <a
                                                                        href="user-products.php?did=<?php echo htmlentities($row['id']); ?>&del=delete&uid=<?php echo $uid ?>">
                                                                        <button class="btn btn-primary"
